...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    */
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.enableSimpleBroker("/chat"); // Prefix for messages that will be handled by the message broker (used for broadcasting messages to clients <used with client subscriptions>)
